...
local function FindClosestPlayer() -- shitty + outdated 
    local Target = nil
...
task.spawn(function()
    ...
    if Enabled  and FindEquippedGun() and CurrentAVTarget.Character:FindFirstChild("BodyEffects") and CurrentAVTarget.Character:FindFirstChild("Head")  then
        Tracer.Enabled = true
